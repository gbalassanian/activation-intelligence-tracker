...
export const MILESTONE_DESCRIPTION: Record<Milestone, string> = {
  ...
  M4_CONSUMING:
    'Business value and habit: sustained usage in any trailing 30-day window — 50+ live conversations with 3+ distinct active days inside a single week, or >40% voice tier credit consumption.',
};
